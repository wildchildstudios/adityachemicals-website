export const metadata = {
  title: "Privacy Policy | Aditya Chemicals",
  description: "Read the Privacy Policy for Aditya Chemicals. Understand how we collect, store, and manage user data.",
};
    ...
    <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 space-y-12">
      ...
      <div className="border-b border-surface-container-highest pb-8">
        ...
        <p className="font-body-lg text-on-surface-variant max-w-2xl mt-4">
          This policy explains how Aditya Chemicals handles visitor information, cookies, and embedded contents.
        </p>
      </div>
